...
public class MBPartner extends X_C_BPartner
{
	...
	//	setHelp(impBP.getHelp());
		...
		//set_Value("c_temp_no", value);
		set_Value("c_temp_no", impBP.get_Value("i_old_student_id"));
		set_Value("c_old_student_id", impBP.get_Value("i_old_student_id"));
		set_Value("last_renewed_year", impBP.get_Value("i_last_renewed_year"));
		set_Value("c_status", impBP.get_Value("i_c_status"));
		set_Value("is_pf", impBP.get_Value("i_is_pf"));
		set_Value("registered_date", impBP.get_Value("i_registered_date"));
		set_Value("c_lastname", impBP.get_Value("i_c_lastname"));
		set_Value("c_initials", impBP.get_Value("i_c_initials"));
		set_Value("student_medium", impBP.get_Value("i_student_medium"));
		set_Value("hear_aat", impBP.get_Value("i_hear_aat"));
		set_Value("aec_tuition_id", impBP.get_Value("i_aec_tuition_id"));
		set_Value("aplication_entered", impBP.get_Value("i_aplication_entered"));
		set_Value("c_student_id", impBP.get_Value("i_student_id"));
		set_Value("c_initials_stand", impBP.get_Value("i_c_initials_stand"));
		set_Value("birthday", impBP.get_Value("i_birthday"));
		set_Value("c_gender", impBP.get_Value("i_c_gender"));
		set_Value("referenceno", impBP.get_Value("i_referenceno"));
		set_Value("c_greeting_id", impBP.get_Value("c_greeting_id"));
