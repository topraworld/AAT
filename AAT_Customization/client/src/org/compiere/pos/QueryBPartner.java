...
public class QueryBPartner extends PosQuery
{
	...
	/**	From Clause							*/
	private static String s_sqlFrom = "c_bpartner";
	/** Where Clause						*/
	private static String s_sqlWhere = "IsActive='Y' and C_BP_Group_ID=1000020"; 
	...
	protected void init()
	{
		...
		String sql = m_table.prepareTable (s_layout, s_sqlFrom, 
			s_sqlWhere, false, "c_bpartner");
			//+ " ORDER BY Value";
		
		/*String sql = "select  C_BPartner_ID, Value, Name, Email, Phone, Postal, City  from C_BPartner_ID "
				+ " from c_bpartner where C_BP_Group_ID=100000482 ";*/
